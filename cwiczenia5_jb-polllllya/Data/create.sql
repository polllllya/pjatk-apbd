...
SELECT COUNT(*) FROM master.dbo.[Order] WHERE IdProduct = 1 AND Amount = ((SELECT Price FROM Product WHERE idProduct = 1) * 5);

SELECT Amount = ((SELECT Price FROM Product WHERE idProduct = 1) * 5);

SELECT COUNT(*) FROM master.dbo.[Order] WHERE IdProduct = 2 AND Amount = 4;